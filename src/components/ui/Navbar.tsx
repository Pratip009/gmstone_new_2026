...
const { categories, loading } = useNavCategories(initialCategories);
  ...
  // Track which dropdowns have "see more" expanded
    ...
    <>
      ...
      <div style={{
        ...
        <a href="mailto:info@alphagemimports.com"
          style={{ color: "#a5b4fc", textDecoration: "none", fontWeight: 500, borderBottom: "1px solid #a5b4fc" }}>
      ...
      >
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto" }}
          ...
          <div className="hidden md:flex" style={{
            flex: "1 1 auto", maxWidth: "340px", minWidth: "180px",
            border: "1.5px solid #e2e0f0",
            borderRadius: "10px",
            alignItems: "center", padding: "0 14px", height: "40px",
            background: "#faf9ff",
            transition: "border-color 0.2s, box-shadow 0.2s",
          }}
            onFocus={() => {}}
          >
            <svg width="14" height="14" viewBox="0 0 16 16" fill="none" style={{ color: "#9f9fc0", marginRight: 8, flexShrink: 0 }}>
                  ...
                  <div ref={profileRef} style={{ position: "relative" }}>
                    <button className="profile-btn" onClick={() => setProfileOpen(!profileOpen)}>
                      ...
                      <svg width="9" height="9" viewBox="0 0 10 10" fill="none"
                        style={{ transition: "transform 0.2s", transform: profileOpen ? "rotate(180deg)" : "rotate(0)", opacity: 0.5 }}>
                    ...
                    <div style={{
                      ...
                      <div style={{ padding: "14px 18px", borderBottom: "1px solid #f0eeff" }}>
                        <p style={{ fontSize: "10px", fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", color: "#9f9fc0", marginBottom: "4px", fontFamily: "'Poppins', sans-serif" }}>Signed in as</p>
                        <p style={{ fontSize: "14px", fontWeight: 600, color: "#1a1a2e", fontFamily: "'Poppins', sans-serif" }}>{user.name}</p>
                      ...
                      <div style={{ padding: "6px 0" }}>
                        ...
                        {isAdmin && <a href="/admin" className="dropdown-item-link" onClick={() => setProfileOpen(false)}>Admin Panel</a>}
                      </div>
                      <div style={{ borderTop: "1px solid #f0eeff", padding: "6px 0" }}>
                        <button onClick={handleLogout} style={{
                          width: "100%", textAlign: "left", padding: "10px 18px",
                          fontSize: "13px", color: "#dc2626", fontFamily: "'Poppins', sans-serif", fontWeight: 500,
                          border: "none", background: "transparent", cursor: "pointer", transition: "background 0.12s",
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
              ...
              >
                <svg width="11" height="11" viewBox="0 0 24 24" fill="none">
                  <path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 10.8 19.79 19.79 0 01.12 2.18 2 2 0 012.11 0h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 14.92z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
                1-914-310-1480
              </a>
          ...
          <div className="flex md:hidden items-center gap-3">
            {user && (
              <Link href="/cart" onClick={() => setMenuOpen(false)}
                style={{ position: "relative", color: "#1a1a2e", textDecoration: "none" }}>
            ...
            <button onClick={() => setMenuOpen(!menuOpen)} aria-label="Toggle menu"
              style={{ background: "transparent", border: "none", cursor: "pointer", padding: "6px", display: "flex", flexDirection: "column", gap: "5px", justifyContent: "center", alignItems: "center" }}>
              <span style={{ display: "block", width: "22px", height: "2px", background: "#1a1a2e", borderRadius: "2px", transition: "transform 0.25s, opacity 0.25s", transform: menuOpen ? "translateY(7px) rotate(45deg)" : "none" }} />
              <span style={{ display: "block", width: "22px", height: "2px", background: "#1a1a2e", borderRadius: "2px", transition: "opacity 0.25s", opacity: menuOpen ? 0 : 1 }} />
              <span style={{ display: "block", width: "22px", height: "2px", background: "#1a1a2e", borderRadius: "2px", transition: "transform 0.25s, opacity 0.25s", transform: menuOpen ? "translateY(-7px) rotate(-45deg)" : "none" }} />
            </button>
          </div>
        </div>
        ...
        <div className="hidden md:block" style={{ borderTop: "1px solid #eeeef8", background: "#faf9ff" }}>
          <div
            style={{ maxWidth: "1280px", margin: "0 auto", display: "flex", alignItems: "stretch" }}
                ...
                >
                  ...
                  {hasSubs && (
                    ...
                    >
                      ...
                      {/* Subcategory links */}
                      {isExpanded ? (
                        /* 3-column grid layout when expanded */
                        <div style={{
                          display: "grid",
      ...
      <div className="fixed z-40 md:hidden" style={{
        top: "var(--navbar-height, 64px)", left: 0, right: 0, bottom: 0,
        background: "#ffffff",
        ...
        <div style={{ padding: "20px 20px 48px", display: "flex", flexDirection: "column" }}>
          ...
          <div style={{
            ...
            <svg width="14" height="14" viewBox="0 0 16 16" fill="none" style={{ color: "#9f9fc0", marginRight: 8 }}>
              <circle cx="6.5" cy="6.5" r="4.5" stroke="currentColor" strokeWidth="1.5" />
              <path d="M10.5 10.5L14 14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
            </svg>
            <input type="text" placeholder="Search gemstones..." style={{
          ...
          {loading && [1, 2, 3, 4, 5].map((i) => (
            <div key={i} style={{
              ...
              backgroundSize: "200% 100%", animation: "navShimmer 1.4s ease infinite",
              borderBottom: "1px solid #f0eeff", borderRadius: 4,
              marginBottom: 2,
            }} />
          ))}
              ...
              <div key={cat._id} style={{ borderBottom: "1px solid #f0eeff" }}>
                ...
                {hasSubs && (
                  <div style={{
                    ...
                    <Link href={`/products?category=${cat.slug}`} onClick={() => setMenuOpen(false)}
                      style={{
          ...
          {user ? (
            <>
              <Link href="/cart" onClick={() => setMenuOpen(false)} style={{
                display: "flex", alignItems: "center", padding: "15px 0", fontSize: "15px", fontWeight: 500,
                color: "#1a1a2e", textDecoration: "none", fontFamily: "'Poppins', sans-serif",
              ...
              {isAdmin && (
                <Link href="/admin" onClick={() => setMenuOpen(false)} style={{
                  display: "flex", alignItems: "center", padding: "15px 0", fontSize: "15px", fontWeight: 600,
                  color: "#b45309", textDecoration: "none", fontFamily: "'Poppins', sans-serif",
                  borderBottom: "1px solid #f0eeff",
                }}>Admin</Link>
              )}
          ...
          <div style={{ marginTop: "40px", paddingBottom: "32px" }}>
            <div style={{ borderTop: "1px solid #f0eeff", paddingTop: "20px" }}>
              <a href="tel:+12128403660" style={{
                display: "flex", alignItems: "center", gap: 8,
                fontSize: "13px", color: "#7c7c9a", textDecoration: "none", marginBottom: "10px",
                fontFamily: "'Poppins', sans-serif", fontWeight: 400,
              }}>
